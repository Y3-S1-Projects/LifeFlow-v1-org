...
import { Bell, Menu, X, User, Droplet, MapPin, HeartPulse, Settings, HelpCircle, ChevronDown } from "lucide-react"
...
const SupportHeader: React.FC = () => {
  ...
  // Check if current path is /support/dashboard
          ...
          <div className="flex-shrink-0 flex items-center">
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-2">
                  <span className="font-bold text-lg text-gray-800 tracking-tight">Life Flow</span>
            ...
            {navLinks.map((link) => (
              <a
                ...
                className={`relative flex items-center gap-1.5 px-3 py-2 text-sm font-medium rounded-md transition-all duration-200
                  ${link.isActive ? "text-red-600 bg-red-50" : "text-gray-600 hover:text-red-600 hover:bg-red-50/50"}`}
              >
                <span
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="p-3 border-b border-gray-100">
                  ...
                  <p className="text-xs text-gray-500">You have {notificationCount} unread messages</p>
                </div>
                <div className="max-h-72 overflow-y-auto">
                  <div className="flex items-start gap-3 p-3 hover:bg-gray-50 transition-colors border-b border-gray-100">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-800">New donation request</p>
                      <p className="text-xs text-gray-500">Camp #34 needs A+ blood type urgently</p>
                  ...
                  <div className="flex items-start gap-3 p-3 hover:bg-gray-50 transition-colors">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-800">New donor registered</p>
                      <p className="text-xs text-gray-500">Rahul Sharma has registered as a donor</p>
            ...
            <div className="relative group">
              <div className="flex items-center gap-2 cursor-pointer p-1 rounded-lg hover:bg-gray-100 transition-colors">
                ...
                <div className="hidden lg:block">
                  <p className="text-sm font-medium text-gray-800">Nimsara Thenuka</p>
              ...
              <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="p-3 border-b border-gray-100">
                  <p className="text-sm font-medium text-gray-800">Nimsara Thenuka</p>
                  <p className="text-xs text-gray-500">support@bloodfinder.org</p>
                </div>
                <div className="py-1">
          ...
          <div className="px-2 pt-2 pb-4 space-y-1 bg-white border-t">
            {navLinks.map((link) => (
              <a
                ...
                className={`flex items-center gap-2 px-3 py-2.5 text-base font-medium rounded-md transition-colors
                  ${link.isActive ? "text-red-600 bg-red-50" : "text-gray-600 hover:text-red-600 hover:bg-red-50"}`}
              >
                {link.icon}
                {link.name}
              </a>
            ...
            <div className="border-t border-gray-200 mt-3 pt-3">
              ...
              <div className="mt-2 space-y-1">
                <a href="/profile" className="block px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-md">
                  Your Profile
                </a>
                <a href="/settings" className="block px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-md">
                  Settings
                </a>
                <a href="/logout" className="block px-3 py-2 text-sm text-red-600 hover:bg-gray-50 rounded-md">
                  Sign out
                </a>
              </div>
            </div>
