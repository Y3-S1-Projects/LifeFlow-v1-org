        ...
        <table className="w-full">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-200">
              ...
              <th className="text-center py-3 px-4 font-medium text-gray-600 text-sm">Blood Type</th>
            ...
            {users.map((user) => (
              <tr key={user._id} className="hover:bg-gray-50 border-b border-gray-200 transition-colors">
                ...
                <td className="py-3 px-4 text-center">
                  <span className={`inline-flex px-2 py-1 rounded-full text-xs font-medium border ${getBloodTypeClass(user.bloodType)}`}>
                    {user.bloodType}
                  </span>
                </td>
                <td className="py-3 px-4 text-right text-sm">{user.weight} kg</td>
                <td className="py-3 px-4 text-center">
                  {user.isVerified ? (
