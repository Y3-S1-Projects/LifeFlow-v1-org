...
const AdminDashboard = () => {
  ...
  // Add a useEffect to save/restore the sidebar state from localStorage
  useEffect(() => {
  ...
  return (
    <div className="w-full">
      <div className="flex min-h-screen bg-gray-100">
        ...
        >
          <div className="p-5 bg-gradient-to-r from-red-600 to-red-700 flex justify-between items-center">
            {!sidebarCollapsed && (
            ...
            {sidebarCollapsed && (
              <Heart className="mx-auto h-6 w-6 fill-white" />
            )}
            <button
          ...
          <div className="bg-white p-6 border-b shadow-sm">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <button
                  onClick={toggleSidebar}
                  className="mr-4 p-2 rounded-md hover:bg-gray-100 hidden lg:block"
                >
