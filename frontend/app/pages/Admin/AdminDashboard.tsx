...
const AdminDashboard = () => {
  ...
  const stats = [
    { title: "Total Donations", value: "1,294", change: "+12.5%", icon: <Droplet className="h-8 w-8 text-white" /> },
    { title: "Active Donors", value: "856", change: "+4.2%", icon: <Users className="h-8 w-8 text-white" /> },
    { title: "Blood Requests", value: "38", change: "-2.5%", icon: <Bell className="h-8 w-8 text-white" /> },
    { title: "Donation Centers", value: "12", change: "+1", icon: <MapPin className="h-8 w-8 text-white" /> }
  ];
  ...
  const recentDonors = [
    { name: "Sarah Johnson", bloodType: "O+", date: "Mar 15, 2025", center: "Central Hospital" },
    { name: "Michael Chen", bloodType: "A-", date: "Mar 14, 2025", center: "Westside Clinic" },
    { name: "Aisha Patel", bloodType: "B+", date: "Mar 14, 2025", center: "Memorial Center" },
    ...
    <div className="flex flex-col min-h-screen bg-gray-50">
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 flex flex-col">
          ...
          {/* Mobile Menu */}
          {mobileMenuOpen && (
            <div className="lg:hidden bg-white border-b shadow-lg absolute top-16 left-0 right-0 z-30">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-500 mt-1">
                  Manage and monitor your blood donation operations
                </p>
              </div>
              {/* <div className="hidden md:flex items-center space-x-3">
                <button className="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors font-medium text-sm flex items-center">
                  <Bell className="h-4 w-4 mr-2" /> Notifications
                </button>
                <button className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-medium text-sm flex items-center">
                  <Clipboard className="h-4 w-4 mr-2" /> Generate Report
                </button>
              </div> */}
            </div>
          </div>

          {/* Page Content - Fixed height with scrolling */}
            ...
            <div className="min-h-full">
                          ...
                          <div key={i} className="space-y-2 bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                            <div className="flex justify-between items-center">
                              ...
                              <span className={`text-xs px-2 py-1 rounded-full ${
                                (blood.current / blood.target) < 0.5 ? 'bg-red-100 text-red-700' : 
                                (blood.current / blood.target) < 0.8 ? 'bg-amber-100 text-amber-700' : 
                            ...
                            <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                              <div 
                                className={`h-full ${
                                  (blood.current / blood.target) < 0.5 ? 'bg-red-500' : 
                                  (blood.current / blood.target) < 0.8 ? 'bg-amber-500' : 'bg-green-500'
                                }`}
                                style={{ width: `${Math.min(100, (blood.current / blood.target) * 100)}%` }}
                              ></div>
                            </div>
                          </div>
                        ))}
              ...
              {activeTab === "centers" && (
                <div className="bg-white rounded-lg shadow-md p-6">
                  ...
                  <p>Donation centers content will go here.</p>
                </div>
              )}
