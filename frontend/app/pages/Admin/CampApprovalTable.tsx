  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg w-full max-w-md shadow-xl">
        <h3 className="text-xl font-bold mb-4 text-gray-800">Provide Rejection Reason</h3>
        <textarea
...
const CampApprovalTable: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-xl font-bold text-gray-800 mb-6">Camp Approval Management</h2>
      ...
      {loading ? (
        ...
        <div className="text-center p-4 text-gray-500">No pending camps found.</div>
      ) : (
              ...
              {camps.map((camp) => (
                <tr key={camp._id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-500">
                    ...
                    <div className="font-medium text-gray-700 mt-1">Organizer: {camp.organizer?.orgName}</div>
                  </td>
                  <td className="px-6 py-4 text-sm text-gray-500">{camp.operatingHours}</td>
                  ...
                  <td className="px-6 py-4 text-sm text-gray-500">{formatDate(camp.createdAt)}</td>
                  <td className="px-6 py-4 text-center">
                    {camp.approvalStatus === "Pending" ? (
                      ...
                      <span className="text-gray-400 text-sm">{camp.approvalStatus}</span>
                    )}
                  </td>
                </tr>
              ))}
