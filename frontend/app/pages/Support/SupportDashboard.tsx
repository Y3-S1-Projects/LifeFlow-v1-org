...
const SupportDashboard = () => {
  ...
  const [faqSortOrder, setFaqSortOrder] = useState<
  ...
  const handleDeleteFAQ = async () => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/api/v1/faqs/${faqToDelete}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
  ...
  const exportFAQFeedbackCSV = () => {
    ...
    const csvData = faqFeedback
      .filter(
        (feedback) => feedback && feedback.faqId && feedback.faqId.question
      ) // Add null check
      .map((feedback) => [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {activeTab === "faq-management" && (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 transition-all duration-200 hover:shadow-md mb-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
              <div>
                ...
                <p className="text-gray-500 mt-1">
                  Create, edit, and manage frequently asked questions for your
                  users
                </p>
              </div>
              <div className="flex space-x-2 mt-4 md:mt-0">
                ...
                <button
                  onClick={() => {
                    ...
                    document
                      .getElementById("faq-create-section")
            ...
            <div
              id="faq-create-section"
              className="bg-red-50 rounded-lg p-6 mb-8 border border-red-100 shadow-sm"
            >
                          ...
                          <div className="p-6">
                            <div className="flex justify-between items-start">
                              <div className="flex-1">
                                <div className="flex items-center">
                                  <h4
                                    className="text-lg font-bold text-gray-800 hover:text-purple-700 cursor-pointer"
                ...
                <div className="text-center py-12 bg-gray-50 rounded-lg border border-dashed border-gray-300">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-gray-500 max-w-md mb-6">
                      You haven't created any FAQs yet. FAQs help your users
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 transition-all duration-200 hover:shadow-md mb-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
              <div>
                ...
                <p className="text-gray-500 mt-1">
                  Track user feedback and improve your FAQs based on user
                  responses
                </p>
              </div>
              <div className="flex space-x-2 mt-4 md:mt-0">
              ...
              {isFeedbackLoading ? (
                ...
                <div className="text-center py-12 bg-gray-50 rounded-lg border border-dashed border-gray-300">
                  <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="text-gray-500 max-w-md">
                      You haven't received any feedback on your FAQs yet.
                      Feedback will appear here once users interact with your
                      FAQs.
                    </p>
                  </div>
                </div>
