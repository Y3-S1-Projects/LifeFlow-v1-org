            ...
            <CardContent className="pt-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <h3 className="text-2xl font-bold">{stats.upcomingCamps}</h3>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {upcomingCamps.map((camp) => (
                  <div key={camp.id} className="p-4 bg-white rounded-lg border">
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-sm text-gray-500">
                          {camp.registeredDonors}/{camp.targetDonors} registered
                        </div>
                      </div>
                    </div>
                    <Progress
                      value={(camp.registeredDonors / camp.targetDonors) * 100}
                      className="h-2"
                    />
                  </div>
                ))}
